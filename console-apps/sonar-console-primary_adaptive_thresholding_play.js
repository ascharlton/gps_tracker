...
const NUM_SIGNALS = 3;
const SIGNAL_THRESHOLD = 80;                   // 40KHz = 60, 200 KHz = 42 is optimum
const CONSISTENCY_SAMPLES = 1;          // 4-6 is good        
const POSITION_TOLERANCE = 1;          
const NOISE_FLOOR_RANGE = 350;          // 200 how far from the end of the signal to sample for noise
const MIN_SIGNAL_SEPARATION = 1; // Minimum index difference for a separate signal
const SNR_FACTOR = 5.4; // New: Multiplier (k) for Noise Std Dev to set the Dynamic Detection Threshold.
...
const PLOT_HEIGHT_SAMPLES = 500;       // 1000 The maximum sample index to display (0 to 1000, max is 1800)
